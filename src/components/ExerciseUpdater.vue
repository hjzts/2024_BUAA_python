    ...
    let canSubmit = computed(() => {
        ...
        if (
            ...
            options.value.forEach((value) => {
                append =
                    append &&
                    !!modal.value.exercise.option[value.charCodeAt(0) - 65]
            })
